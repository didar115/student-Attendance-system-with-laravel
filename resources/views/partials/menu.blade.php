...
{{-- <li class="nav-item"><a class="nav-link" href="/add-data">
<svg class="nav-icon">
<use xlink:href=""></use>
</svg>Show all Admin</a></li> --}}
...
</div></div></div></div><div class="simplebar-placeholder" style="width: 256px; height: 1296px;"></div></div>
{{-- <div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"> --}}
    <div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div>
    <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
    {{-- <div class="simplebar-scrollbar" style="height: 31px; transform: translate3d(0px, 0px, 0px); display: block;"></div> --}}
</div></ul>
